/**
 * @constant ABOUT_HEADER_STYLES
 * @description Styling classes for the AboutHeader component using modern dark palette
 */
export const ABOUT_HEADER_STYLES = {
    ...
    backButton: 'inline-flex items-center text-blue-100 hover:text-white mb-4 transition-colors duration-200 font-medium',
