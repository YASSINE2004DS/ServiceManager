/**
 * @constant SERVICES_HEADER_STYLES
 * @description Styling classes for the ServicesHeader component using modern dark palette
 */
export const SERVICES_HEADER_STYLES = {
