...
import { faUserCircle, faSignOutAlt, faPlusCircle, faIdCardAlt } from '@fortawesome/free-solid-svg-icons';
import './PageHeader.css'
...
const Header = ({  }) => {
  ...
  const userInitials = ( InfoUser.first_name && InfoUser.last_name) ? InfoUser.first_name[0].toUpperCase() + InfoUser.last_name[0].toUpperCase() 
                                                                    : 'US'; // "YE" for Yassine, "US" for User
      ...
      <div className="header-right">
        <div className="user-info-container" ref={dropdownRef}>
          ...
          <div className="avatar-wrapper" onClick={toggleDropdown}>
            {/* Avatar de l'utilisateur (initiales ou icône) */}
            ...
            <div className="dropdown-menu">
              <ul>
                ...
                <li onClick={handleAddIntervention}>
                  <FontAwesomeIcon icon={faPlusCircle} className="dropdown-icon" />
